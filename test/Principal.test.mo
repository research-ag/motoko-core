...
suite("isCanister", func() {
  ...
  test("returns false for the management canister", func() {
    assert not Principal.isCanister(Principal.fromText("aaaaa-aa"));
  });

  test("returns false for the anonymous principal", func() {
    assert not Principal.isCanister(Principal.fromText("2vxsx-fae"));
  });

  test("returns false for self-authenticating ids (typically user principals)", func() {
  ...
  test("returns false for reserved principals", func() {
...
suite("isSelfAuthenticating", func() {
  test("returns false for opaque ids (typically canister principals)", func() {
  ...
  test("returns true for self-authenticating ids (typically user principals)", func() {
...
suite("isReserved", func() {
  ...
  test("returns true for reserved principals", func() {
